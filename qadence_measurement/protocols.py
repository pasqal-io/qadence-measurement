...
PROTOCOL_TO_MODULE = {
    "tomography": ("qadence_measurement.tomography", "Tomography"),
    "shadow": ("qadence_measurement.shadow", "ShadowManager"),
    "robust_shadow": ("qadence_measurement.robust_shadow", "RobustShadowManager"),
}
